...
SWTS_sheath_begin = 24*60*(datenum(boundaries(1,where_the_SWTS_at-1),boundaries(2,where_the_SWTS_at-1),...
...
STSW_next_begin = 24*60*(datenum(boundaries(1,where_the_STSW_at+1),boundaries(2,where_the_STSW_at+1),...
...
SW_to_sheath(9,:) = SW_to_sheath(8,:) - SWTS_sheath_begin;
sheath_to_SW(9,:) = STSW_next_begin - sheath_to_SW(8,:);
